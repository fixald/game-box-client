...
<template>
  <div class="account-page">
    ...
    <nav><button v-for="tab in tabs" :key="tab.key" :class="{ active: activeTab === tab.key, highlight: tab.highlight }" @click="activeTab = tab.key">{{ tab.label }}<b v-if="tab.key === 'messages' && unreadCount">{{ unreadCount }}</b></button></nav>
